/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 33dacb7fad85578e427a60213cd20207)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JEV_MODEL" | "TYPESAFE_API_KEY">> {}
}
